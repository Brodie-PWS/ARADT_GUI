...
def pre_process(sample_fpath):
        ...
        # Create empty Numpy Array for storing Features and labels
        feature_array = np.zeros((10,10))

        filename = os.path.basename(sample_fpath)
